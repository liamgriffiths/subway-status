...
_react2["default"].render(_react2["default"].createElement(_componentsApp2["default"], { data: window.DATA }), body);
...
var App = (function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      var statuses = this.props.data.statuses.map(function (_ref) {
        var name = _ref.name;
